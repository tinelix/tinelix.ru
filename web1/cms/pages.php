<?php
    ...
    function showWebsiteBannersPage($db, $html_encoding) {
            ...
            $html = "\r\n                    <td bgcolor=\"#151515\" valign=\"top\">
                     ...
                     \r\n<p style=\"font-size: 12pt\"><b>ВНИМАНИЕ!</b> Для показа баннеров на современных браузерах советуем отключить блокировщик рекламы или добавить сайт в исключения блокировки.";
