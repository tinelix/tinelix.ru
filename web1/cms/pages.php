<?php
    ...
    function showProjectPage($i, $html_encoding) {
        ...
        if($i == 1) {
            ...
            $html = "
                ...
                \r\n                            </ol>
                \r\n                            <h4>Журнал изменений</h4>
                \r\n                            <h5>1.1, сборка №198</h5>
                \r\n                            <ol>
                \r\n                                <li>Добавлена полноценная поддержка фотографий, видео и опросов в окне \"Комментарии\" (благодаря небольшому рефакторингу)</li>
                \r\n                                <li>Заменена оригинальная библиотека Emojicon на его форк Twemojicon. Причина: rockerhieu/emojicon#17</li>
                \r\n                                <li>Добавлена краш-репортер ACRA 4.6.0 (Application Crash Reporting for Android)</li>
                \r\n                            </ol>
                \r\n                            <h4>Исходный код</h4>
                \r\n                            <div align=\"center\">
                \r\n                                <a href=\"https://github.com/openvk/mobile-android-legacy\">для Android</a>
                \r\n                            </div>
                \r\n                            <h4>Предварительно-скомпилированные файлы</h4>
                \r\n                            <div align=\"center\">
    ...
    function showWebsiteBannersPage($db, $html_encoding) {
            ...
            $html = "\r\n                    <td bgcolor=\"#151515\" valign=\"top\">
                     ...
                     \r\n<p><div style=\"font-size: 12pt; background-color: #b16000\"><b>ВНИМАНИЕ!</b> Для показа баннеров на современных браузерах советуем отключить блокировщик рекламы или добавить сайт в исключения блокировки.</div>";
